...
<%@page import="FORM.BorrarFormulario"%>
...
<html>
	...
	<%@page import="org.apache.log4j.Logger"%>
        ...
        <ul class="nav nav-tabs" role="tablist">
               <%
                out.print("<button align=\"center\" class=\"btn btn-primary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Volver\"><div class=\"col-md-3\"><a href=\"mostrarRespuestaHD.jsp?Submit=" + Cod + " \"><i class=\"fas fa-arrow-left\" style=\"font-size:40px;color:white\"></i></a></button>");
                        %>
            </ul>
            <div class="container">
                    ...
                    for(int j=0; j<listaP.size();j++)
                    {
                        ...
                        try{
                            ...
                            if(listaP.get(j).getCodigo_tipo_pregunta()==6)
                            {
                                ...
                                out.println("<div ><center><button class=\"btn btn-success\"type=\"submit\" name=\"archivo\">Descargar</button></center></div>");
                                out.println("</form>");
                                //out.println("</div>");
                                codR++;
                            }
         ...
         function Imprimir_Contenido()
          ...
          <br>
            <div class="row">
                ...
                <button align="center" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Volver"> <div class="col-md-3"><a href="mostrarFormularioUsuarioHD.jsp" + Cod + " " ><i class='	fas fa-arrow-left' style='font-size:40px;color:white'></i></a></button>
