    ...
    <%
      //out.println("<div class=\"row\">");
        ...
        for (int i = 0; i < listaF.size(); i++) {
            ...
            out.print("<div class=\"col-md-4\"><button class=\"btn btn-outline-warning\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Ver \" type=\"text\" name=\"Submit\" onclick=\"this.form.action='mostrar.jsp';this.form.submit();\" value='" + cod + listaF.get(i).getCodigo_formulario() + "'><i class=\"fas fa-eye\" style='font-size:20px'></i></button><button class=\"btn btn-outline-info\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar \" type=\"text\" name=\"Submit\" onclick=\"this.form.action='modificar.jsp';this.form.submit();\" value='" + cod + listaF.get(i).getCodigo_formulario() + "'><i class=\"fas fa-pen\" style='font-size:20px'></i></button><button class=\"btn btn-outline-danger\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Eliminar\" type=\"text\" name=\"Submit\" onclick=\"this.form.action='eliminar.jsp';this.form.submit();\" value='" + cod + listaF.get(i).getCodigo_formulario() + "'><i class=\"fas fa-\" style='font-size:20px'>&#xf2ed;</i></button><button class=\"btn btn-outline-success\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Publicar \" type=\"text\" name=\"Submit\" onclick=\"this.form.action='publicarUsuario.jsp';this.form.submit();\" value='" + cod + listaF.get(i).getCodigo_formulario() + "'><i class=\"fas fa-chalkboard-teacher\" style='font-size:20px'></i></button></div>");
            out.print("</div></form>");
