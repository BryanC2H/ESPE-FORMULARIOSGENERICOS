                        ...
                        <td>
                            <div class="btn-toolbar text-center" role="toolbar">
                                <div class="row">
                                    ...
                                    <div class="btn-group col-md-20">
                                        <div class="col-md-2"><button class="btn btn-outline-warning" data-toggle="tooltip" data-placement="top" title="Ver" class="btn btn-default" type="text" name="Submit" onclick="this.form.action='mostrar.jsp';this.form.submit();" value="<%= ts.getInt("CODIGO_UZGTFORMULARIOS")%>"><i class="fas fa-eye" style='font-size:20px'></i></button></div>
                                          
                                        <div class="col-md-2"><button class="btn btn-outline-info" data-toggle="tooltip" data-placement="top" title="editar" class="btn btn-default" type="text" name="Submit" onclick="this.form.action='modificar.jsp';this.form.submit();" value="<%= ts.getInt("CODIGO_UZGTFORMULARIOS")%>"><i class="fas fa-pen" style='font-size:20px'></i></button></div>
                                          
                                        <div class="col-md-2"><button class="btn btn-outline-danger" data-toggle="tooltip" data-placement="top" title="borrar" class="btn btn-default" type="text" name="Submit" onclick="this.form.action='eliminar.jsp';this.form.submit();" value="<%= ts.getInt("CODIGO_UZGTFORMULARIOS")%>"><i class="fas fa-trash" style='font-size:20px'></i></button></div>

                                       <div class="col-md-2"><button class="btn btn-outline-success" data-toggle="tooltip" data-placement="top" title="publicar" class="btn btn-default" type="text" name="Submit" onclick="this.form.action='publicarUsuario.jsp';this.form.submit();" value="<%= ts.getInt("CODIGO_UZGTFORMULARIOS")%>"><i class="fas fa-chalkboard-teacher" style='font-size:20px'></i></button></div>
