...
<html>  
    <head>
        ...
        <%
            ...
            int PIDMget = Integer.parseInt(pidm);
...
//Muestra los Formularios Llenados por el Usuario
    if (listaF5.isEmpty()) {
        ...
        for (int i = 0; i < listaF5.size(); i++) {
            ...
            out.print("<div class=\"col-md-1\"><button class=\"btn btn-info\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Ver\" class=\"btn btn-default\" type=\"text\" name=\"Submit\" onclick=\"this.form.action='mostrarFormularioUsuarios.jsp';this.form.submit();\" value='" + cod + listaF5.get(i).getCodigo_formulario() + "'><i class=\"fas fa-eye\" style='font-size:20px'></i></button></div>");
            out.print("<div class=\"col-md-3\"></div>");
            out.print("</div></form>");
            //out.print("<form action=\"publicarUsuario.jsp\" method=\"POST\" target=\"_self\" style=\"display: inline;\">");
            //out.print("<div class=\"row\">");
