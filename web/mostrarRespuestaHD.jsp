                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">                    
                        <li role="presentation">
                            <a href="mostrarFormularioHD.jsp">
                                    ...
                                    <div class="btn-toolbar text-center" role="toolbar">
                                        <div class="row">
                                            ...
                                            <div class="btn-group col-md-12">
                                                <center><div class="col-md-1"><button class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Ver" class="btn btn-default" type="submit" name="Submit" onclick="this.form.action = 'mostrarFormularioUsuarioHD.jsp';this.form.submit();" value="<%= ts.getInt("CODIGO_UZGTFORMULARIOS")%>"><i class="fas fa-eye" style='font-size:20px'></i></button></div></center>
                                            </div>
                                            <div class="col-md-4 center-block"></div>
                                        </div>
                                    </div>
