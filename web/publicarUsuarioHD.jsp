...
<html>
    ...
    <%
        out.println("<div class=\"col-md-12\"><center><button class=\"btn btn-success btn-lg\" type=\"submit\" name=\"Submit\" onclick=\"this.form.action='estadoPublicacionHD.jsp';this.form.submit();\" value=\"" + Cod + "\">Publicar</button></center></div>");
