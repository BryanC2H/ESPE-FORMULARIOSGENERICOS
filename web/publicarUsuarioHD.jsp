...
<html>
    ...
    <form action="estadoPublicacionHD.jsp" method="POST">
        ...
        <div class="container">
            ...
            <div id="ifYes" style="display: none;">
                <textarea name="queryRes" rows="1" cols="150" class="panel-body" placeholder="Ingrese el query de restriccion"></textarea>
            </div>
    ...
    <%
        out.println("<div class=\"col-md-10\"><center><button class=\"btn btn-success\" type=\"submit\" name=\"Submit\" onclick=\"this.form.action='estadoPublicacionHD.jsp';this.form.submit();\" value=\"" + Cod + "\">Publicar</button></center></div>");
...
<%
    out.println("<div class=\"col-md-12\"><center><button class=\"btn btn-success btn-lg\" type=\"submit\" name=\"Submit\" onclick=\"this.form.action='estadoPublicacionHD.jsp';this.form.submit();\" value=\"" + Cod + "\", \"" + eF + "\" >Publicar</button></center></div>");
