...
<html>
	...
	<%@page import="org.apache.log4j.Logger"%>
        ...
        <div class="row bg-default">
            ...
            <div class="col-md-"><center><h1>Gestión de Formularios</h1></center></div>
            <div class="col-md-2"></div>
        </div>
        <ul class="nav nav-tabs" role="tablist">
               <div class="col-md-1" align="center"><button align="center" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Volver"><a href="mostrarFormularioHD.jsp"><i class='fas fa-arrow-left' style='font-size:40px;color:white'></i></a></button></div>
	...
	<div class="row">
                                                ...
                                                <div class="col-md-3" align="center"><button align="center" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Volver"><a href="mostrarFormularioHD.jsp"><i class='fas fa-arrow-left' style='font-size:40px;color:white'></i></a></button></div>
