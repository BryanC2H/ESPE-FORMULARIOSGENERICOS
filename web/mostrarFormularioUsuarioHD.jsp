...
<html>
    <head>
        ...
        <title>Usuario-Formulario00</title>
        <link href="css/bootstrap.min.css" rel="stylesheet"/>
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="navbar navbar-inverse navbar-fixed-top navbar-custom" role="presentation"><a style="color:white" href="mostrarRespuestaHD.jsp"><i class="fas fa-" style='font-size:24px'>&#xf15c;</i><strong> Respuestas</strong></a></li></br>
        ...
        if (listaU.isEmpty()) {
            ...
            if (listaF.getFirst().getTipoFormulario().equals("N") || listaF.getFirst().getTipoFormulario().equals("M")) {
                ...
                for (int i = 0; i < listaU.size(); i++) {
                    ...
                    out.print("<form action=\"mostrarRespuestaUsuarioHD.jsp\" method=\"POST\" target=\"_self\">");
                    out.print("<div class=\"row\">");
