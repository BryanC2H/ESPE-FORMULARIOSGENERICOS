...
<ul class="nav nav-tabs " role="tablist" >
    ...
    <%        
        out.print("<li class=\"navbar navbar-inverse navbar-fixed-top navbar-custom\" role=\"presentation\"><a style=\"color:white;\" href=\" mostrarFormularioHD.jsp\"><i class=\"fas fa-tools\" style='font-size:24px'></i><strong> Gestión </strong></a></li>");
    %>
</ul>
...
<form action="LoginServlet" method="POST">
    ...
    <%
        ...
        for (int i = 0; i < listaF.size(); i++) {
            ...
            out.print("<div class=\"col-md-1\" align=\"justify\"><p id=\"cod\">" + listaF.get(i).getCodigo_formulario() + "</p></div>");
            out.print("<div class=\"col-md-3\" align=\"justify\"><p name=\"nombre\">" + listaF.get(i).getNombre_formulario() + "</p></div>");

            out.print("<div class=\"col-md-1\"><button class=\"btn btn-outline-info\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Ver\" class=\"btn btn-default\" type=\"text\" name=\"Submit\" onclick=\"this.form.action='mostrarFormularioUsuarioHD.jsp';this.form.submit();\" value='" + cod + listaF.get(i).getCodigo_formulario() + "'><i class=\"fas fa-eye\" style='font-size:20px'></i></button></div>");
            out.print("<div class=\"col-md-3\"></div>");
            out.print("</center></div></form>");
